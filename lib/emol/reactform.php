	...
	if ( $option != '' ) {
		...
		$frm = '
                    <div class="emol-react-row" id="emol-firstname-row">
                        ...
                        <div class="emol-input-wrapper">
                            <input type="text" class="emol-text-input ' . $req . '" value="' . $data['firstname'] . '" name="firstname" id="emol-firstname" />
                        </div>
                    </div>
                    ...
                    <div class="emol-react-row" id="emol-lastname-row">
                        ...
                        <div class="emol-input-wrapper">
                            ...
                            <input type="text" class="emol-text-input ' . $req . '"  value="' . $data['lastname'] . '" name="lastname" id="emol-lastname" />
                        </div>
                    </div>
                    ';
	} else {
		...
		if ( $option != '' ) {
			...
			$frm .= '
                        ...
                        <div class="emol-input-wrapper">
                        <input type="text" class="emol-text-input ' . $req . '" name="firstname" value="' . $data['firstname'] . '"  id="emol-firstname" />
                        </div>
                        </div>';
		}
		...
		if ( $option != '' ) {
			...
			$frm .= '
                        ...
                        <div class="emol-input-wrapper">
                        <input type="text" class="emol-text-input ' . $req . '" name="middlename" value="' . $data['middlename'] . '"  id="emol-middlename" />
                        </div>
                        </div>';
		}
		...
		if ( $option != '' ) {
			...
			$frm .= '
                        ...
                        <div class="emol-input-wrapper">
                        <input type="text" class="emol-text-input ' . $req . '" name="lastname" value="' . $data['lastname'] . '" id="emol-lastname" />
                        </div>
                        </div>';
		}
	}
	...
	if ( $option != '' ) {
		...
		$frm = '
                    <div class="emol-react-row" id="emol-address-row">
                        ...
                        <div class="emol-input-wrapper">
                            <input type="text" class="emol-text-input emol-small ' . $req . '" value="' . $data['zipcode'] . '"  minlength=6 name="zipcode" id="emol-zipcode"  />
		...
		if ( $option != '' ) {
			...
			$frm .= '<div class="emol-react-row" id="emol-street-row">
                        ...
                        <div class="emol-input-wrapper">
                        <input type="text" class="emol-text-input ' . $req . '" name="street" value="' . $data['street'] . '"  id="emol-street"  />
                        </div>
                        </div>';
		}
		...
		if ( $option != '' ) {
			...
			$frm .= '<div class="emol-react-row" id="emol-housenumber-row">
                        ...
                        <div class="emol-input-wrapper">
                        <input type="text" class="emol-text-input ' . $req . '" name="housenumber" value="' . $data['housenumber'] . '"  id="emol-housenumber"  />
                        </div>
                        </div>';
		}
		...
		if ( $option != '' ) {
			...
			$frm .= '<div class="emol-react-row" id="emol-extension-row">
                        ...
                        <div class="emol-input-wrapper">
                        <input type="text" class="emol-text-input ' . $req . '" name="extension" value="' . $data['extension'] . '"  id="emol-extension"  />
                        </div>
                        </div>';
		}
		...
		if ( $option != '' ) {
			...
			$frm .= '<div class="emol-react-row" id="emol-zipcode-row">
                        ...
                        <div class="emol-input-wrapper">
                        <input type="text" class="emol-text-input ' . $req . '" name="zipcode" value="' . $data['zipcode'] . '" id="emol-zipcode"  />
                        </div>
                        </div>';
		}
		...
		if ( $option != '' ) {
			...
			$frm .= '<div class="emol-react-row" id="emol-city-row">
                        ...
                        <div class="emol-input-wrapper">
                        <input type="text" class="emol-text-input ' . $req . '" name="city" value="' . $data['city'] . '"  id="emol-city"  />
                        </div>
                        </div>';
		}
	...
	if ( $option != '' ) {
		...
		$frm = '
                    <div class="emol-react-row" id="emol-email-row">
                        ...
                        <div class="emol-input-wrapper">
                            <input type="text" class="emol-text-input ' . $req . '" name="email" value="' . $data['email'] . '"  id="emol-email" />
                        </div>
                    </div>
                    ';
	}
	...
	if ( $option != '' ) {
		...
		$frm = '
                    <div class="emol-react-row" id="emol-phone-row">
                        ...
                        <div class="emol-input-wrapper">
                            <input type="text" class="emol-text-input ' . $req . '" name="phonenumber" value="' . $data['phonenumber'] . '" id="emol-phonenumber" />
                        </div>
                    </div>
                    ';
	}
	...
	if ( $option != '' ) {
		...
		$frm = '
                    <div class="emol-react-row" id="emol-department-row">
                        ...
                        <div class="emol-input-wrapper">
                            <input type="text" class="emol-text-input ' . $req . '" name="department" value="' . $data['department'] . '" id="emol-department" />
                        </div>
                    </div>
                    ';
	}
	...
	if ( $option != '' ) {
		...
		$frm = '
                    <div class="emol-react-row" id="emol-coc-row">
                        ...
                        <div class="emol-input-wrapper">
                            <input type="text" class="emol-text-input ' . $req . '" name="coc" value="' . $data['coc'] . '" id="emol-coc" />
                        </div>
                    </div>
                    ';
	}
	...
	if ( $option != '' ) {
		...
		$frm = '
                    <div class="emol-react-row" id="emol-jobName-row">
                        ...
                        <div class="emol-input-wrapper">
                            <input type="text" class="emol-text-input ' . $req . '" name="jobName" value="' . $data['jobName'] . '" id="emol-jobName" />
                        </div>
                    </div>
	...
	if ( $option != '' ) {
		...
		$frm = '
                    <div class="emol-react-row" id="emol-logo-row">
                        ...
                        <div class="emol-input-wrapper">
                            <input type="file" class="emol-text-input emol-file ' . $req . '" name="logo" id="emol-logo" />
                        </div>
                    </div>
                    ';
	}
